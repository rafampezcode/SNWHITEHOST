...
const textMap: Record<string, TranslationEntry> = {
  ...
  "CSGO - Plan Faze - US": {
    en: "CSGO - Plan Faze - US",
    es: "CSGO - Plan Faze - US",
    de: "CSGO - Plan Faze - US",
    nl: "CSGO - Plan Faze - US",
  },
  "CSSOURCE - Plan Arctic Avengers": {
    en: "CSSOURCE - Plan Arctic Avengers",
    es: "CSSOURCE - Plan Arctic Avengers",
    de: "CSSOURCE - Plan Arctic Avengers",
    nl: "CSSOURCE - Plan Arctic Avengers",
  },
  "CSSOURCE - Plan Phoenix Connexion": {
    en: "CSSOURCE - Plan Phoenix Connexion",
    es: "CSSOURCE - Plan Phoenix Connexion",
    de: "CSSOURCE - Plan Phoenix Connexion",
    nl: "CSSOURCE - Plan Phoenix Connexion",
  },
  "CSSOURCE - Plan SAS": {
    en: "CSSOURCE - Plan SAS",
    es: "CSSOURCE - Plan SAS",
    de: "CSSOURCE - Plan SAS",
    nl: "CSSOURCE - Plan SAS",
  },
  "CSSOURCE - Plan GSG-9": {
    en: "CSSOURCE - Plan GSG-9",
    es: "CSSOURCE - Plan GSG-9",
    de: "CSSOURCE - Plan GSG-9",
    nl: "CSSOURCE - Plan GSG-9",
  },
  "CS2 - Plan Bestia - US": {
    en: "CS2 - Bestia Plan - US",
    es: "CS2 - Plan Bestia - US",
    de: "CS2 - Bestia-Plan - US",
    nl: "CS2 - Bestia Plan - US",
  },
  "CS2 - Plan Furia - US": {
    en: "CS2 - Furia Plan - US",
    es: "CS2 - Plan Furia - US",
    de: "CS2 - Furia-Plan - US",
    nl: "CS2 - Furia Plan - US",
  },
  "CS2 - Plan Mouz - US": {
    en: "CS2 - Mouz Plan - US",
    es: "CS2 - Plan Mouz - US",
  ...
  "CS16 - Plan Desert Eagle": {
    en: "CS16 - Plan Desert Eagle",
    es: "CS16 - Plan Desert Eagle",
    de: "CS16 - Plan Desert Eagle",
    nl: "CS16 - Plan Desert Eagle",
  },
  "CS16 - Plan M4A1": {
    en: "CS16 - Plan M4A1",
    es: "CS16 - Plan M4A1",
  ...
  "Optimized network routes and premium hardware for minimal ping.": {
    en: "Optimized network routes and premium hardware for minimal ping.",
    es: "Rutas de red optimizadas y hardware premium para minimizar el ping.",
    de: "Optimierte Netzwerkrouten und Premium-Hardware für minimalen Ping.",
    nl: "Geoptimaliseerde netwerkroutes en premium hardware voor minimale ping.",
  },
  "SourceMod Ready": {
    en: "SourceMod Ready",
    es: "SourceMod listo",
  ...
  "Full support for SourceMod and MetaMod plugins.": {
    en: "Full support for SourceMod and MetaMod plugins.",
    es: "Soporte completo para plugins SourceMod y MetaMod.",
    de: "Volle Unterstützung für SourceMod- und MetaMod-Plugins.",
    nl: "Volledige ondersteuning voor SourceMod- en MetaMod-plugins.",
  },
  "Advanced protection keeps your server online during attacks.": {
    en: "Advanced protection keeps your server online during attacks.",
    es: "Protección avanzada mantiene tu servidor en línea durante ataques.",
    de: "Erweiterter Schutz hält Ihren Server während Angriffen online.",
    nl: "Geavanceerde bescherming houdt uw server online tijdens aanvallen.",
  },
  "Instant Setup": {
    en: "Instant Setup",
  ...
  "Your server is ready within minutes of ordering.": {
    en: "Your server is ready within minutes of ordering.",
    es: "Tu servidor está listo en minutos después de la compra.",
    de: "Ihr Server ist innerhalb von Minuten nach der Bestellung bereit.",
    nl: "Uw server is binnen enkele minuten na bestelling klaar.",
  },
  "Workshop Maps": {
    en: "Workshop Maps",
    es: "Mapas de Workshop",
    de: "Workshop-Maps",
    nl: "Workshop maps",
  },
  "Install any Steam Workshop map with one click.": {
    en: "Install any Steam Workshop map with one click.",
    es: "Instala cualquier mapa de Steam Workshop con un clic.",
    de: "Installiere jede Steam-Workshop-Map mit einem Klick.",
    nl: "Installeer elke Steam Workshop-map met één klik.",
  },
  "24/7 Support": {
    en: "24/7 Support",
    es: "Soporte 24/7",
  ...
  "Expert support available around the clock.": {
    en: "Expert support available around the clock.",
    es: "Soporte experto disponible las 24 horas.",
    de: "Experten-Support rund um die Uhr verfügbar.",
    nl: "Deskundige ondersteuning, de klok rond beschikbaar.",
  },
  "Do you support SourceMod and MetaMod?": {
    en: "Do you support SourceMod and MetaMod?",
    es: "¿Soportan SourceMod y MetaMod?",
    de: "Unterstützen Sie SourceMod und MetaMod?",
    nl: "Ondersteunen jullie SourceMod en MetaMod?",
  },
  "Yes, you can install SourceMod, MetaMod, and custom plugins.": {
    en: "Yes, you can install SourceMod, MetaMod, and custom plugins.",
    es: "Sí, puedes instalar SourceMod, MetaMod y plugins personalizados.",
    de: "Ja, Sie können SourceMod, MetaMod und benutzerdefinierte Plugins installieren.",
    nl: "Ja, je kunt SourceMod, MetaMod en aangepaste plugins installeren.",
  },
  "Can I change the server location?": {
    en: "Can I change the server location?",
    es: "¿Puedo cambiar la ubicación del servidor?",
    de: "Kann ich den Serverstandort ändern?",
    nl: "Kan ik de serverlocatie wijzigen?",
  },
  "Currently these plans are hosted in the United States.": {
    en: "Currently these plans are hosted in the United States.",
    es: "Actualmente estos planes se alojan en Estados Unidos.",
    de: "Derzeit werden diese Pläne in den Vereinigten Staaten gehostet.",
    nl: "Deze plannen worden momenteel in de Verenigde Staten gehost.",
  },
  "Is the server protected against DDoS?": {
    en: "Is the server protected against DDoS?",
    es: "¿El servidor está protegido contra DDoS?",
    de: "Ist der Server gegen DDoS geschützt?",
    nl: "Is de server beschermd tegen DDoS?",
  },
  "Yes, all plans include advanced anti-DDoS protection.": {
    en: "Yes, all plans include advanced anti-DDoS protection.",
    es: "Sí, todos los planes incluyen protección anti-DDoS avanzada.",
    de: "Ja, alle Pläne enthalten erweiterten Anti-DDoS-Schutz.",
    nl: "Ja, alle plannen bevatten geavanceerde anti-DDoS-bescherming.",
  },
  "How fast is provisioning?": {
    en: "How fast is provisioning?",
    es: "¿Qué tan rápido es el aprovisionamiento?",
    de: "Wie schnell erfolgt die Bereitstellung?",
    nl: "Hoe snel is de provisioning?",
  },
  "Servers are deployed automatically within minutes after payment.": {
    en: "Servers are deployed automatically within minutes after payment.",
    es: "Los servidores se despliegan automáticamente en minutos después del pago.",
    de: "Server werden innerhalb weniger Minuten nach der Zahlung automatisch bereitgestellt.",
    nl: "Servers worden automatisch binnen enkele minuten na betaling uitgerold.",
  },
  "Low latency gameplay": {
    en: "Low latency gameplay",
    es: "Juego con baja latencia",
    de: "Niedrige Latenz im Spiel",
    nl: "Gameplay met lage latentie",
  },
  "SourceMod ready": {
    en: "SourceMod ready",
    es: "SourceMod listo",
  ...
  "Anti-DDoS included": {
    en: "Anti-DDoS included",
    es: "Anti-DDoS incluido",
    de: "Anti-DDoS inklusive",
    nl: "Anti-DDoS inbegrepen",
  },
  "24/7 support": {
    en: "24/7 support",
    es: "Soporte 24/7",
  ...
  "All our CS2 servers run at 128 tick for the best competitive experience.": {
    en: "All our CS2 servers run at 128 tick for the best competitive experience.",
    es: "Todos nuestros servidores CS2 funcionan a 128 tick para la mejor experiencia competitiva.",
    de: "Alle unsere CS2-Server laufen mit 128 Tick für das beste kompetitive Erlebnis.",
    nl: "Al onze CS2-servers draaien op 128 tick voor de beste competitieve ervaring.",
  },
  "Storage": {
    en: "Storage",
    es: "Almacenamiento",
  ...
  "Your CS2 server is ready to play within minutes of ordering.": {
    en: "Your CS2 server is ready to play within minutes of ordering.",
    es: "Tu servidor CS2 estará listo para jugar en minutos tras la compra.",
    de: "Ihr CS2-Server ist innerhalb weniger Minuten nach der Bestellung spielbereit.",
    nl: "Uw CS2-server is binnen enkele minuten na bestelling klaar om te spelen.",
  },
  "All Game Modes": {
    en: "All Game Modes",
    es: "Todos los modos de juego",
    de: "Alle Spielmodi",
    nl: "Alle spelmodi",
  },
  "Competitive, casual, deathmatch, arms race, and custom modes.": {
    en: "Competitive, casual, deathmatch, arms race, and custom modes.",
    es: "Competitivo, casual, deathmatch, arms race y modos personalizados.",
    de: "Kompetitiv, Casual, Deathmatch, Waffenrennen und benutzerdefinierte Modi.",
    nl: "Competitief, casual, deathmatch, arms race en aangepaste modi.",
  },
  "8GB DDR5": {
    en: "8GB DDR5",
    es: "8GB DDR5",
  ...
  "What tick rate do your servers run at?": {
    en: "What tick rate do your servers run at?",
    es: "¿A qué tick rate funcionan los servidores?",
    de: "Mit welcher Tick-Rate laufen ваши Server?",
    nl: "Welke tickrate gebruiken jullie servers?",
  },
  "All our CS2 servers run at 128 tick rate for the smoothest, most competitive gameplay experience.": {
    en: "All our CS2 servers run at 128 tick rate for the smoothest, most competitive gameplay experience.",
    es: "Todos nuestros servidores CS2 funcionan a 128 tick rate para una experiencia más fluida y competitiva.",
    de: "Alle unsere CS2-Server laufen mit 128 Tick-Rate für das flüssigste, kompetitivste Spielerlebnis.",
    nl: "Al onze CS2-servers draaien op 128 tickrate voor de soepelste, meest competitieve ervaring.",
  },
  "16GB DDR5": {
    en: "16GB DDR5",
    es: "16GB DDR5",
  ...
  "Can I run workshop maps?": {
    en: "Can I run workshop maps?",
    es: "¿Puedo usar mapas de Workshop?",
    de: "Kann ich Workshop-Maps nutzen?",
    nl: "Kan ik workshop maps gebruiken?",
  },
  "Yes! You can easily add any Steam Workshop map to your server through the control panel.": {
    en: "Yes! You can easily add any Steam Workshop map to your server through the control panel.",
    es: "¡Sí! Puedes añadir cualquier mapa de Steam Workshop desde el panel de control.",
    de: "Ja! Sie können jede Steam-Workshop-Map über das Control Panel hinzufügen.",
    nl: "Ja! Je kunt elke Steam Workshop-map eenvoudig via het control panel toevoegen.",
  },
  ...
  "Demo recording": {
    en: "Demo recording",
    es: "Grabación de demos",
    de: "Demo-Aufzeichnung",
    nl: "Demo-opname",
  },
  "Anti-DDoS incluido": {
    en: "Anti-DDoS included",
