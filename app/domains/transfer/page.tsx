...
export default function TransferDomainsPage() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault()
    if (domain.trim()) {
      window.location.href = `https://clients.snwhitehosting.com/cart.php?a=add&domain=transfer&query=${encodeURIComponent(domain)}`
    }
  }
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">
                {translateProductText("Transfer Domains", language)}
              </h1>
              ...
              <form onSubmit={handleSearch} className="mt-10 mx-auto max-w-2xl">
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <Button type="submit" variant="destructive" size="lg" className="h-14 px-8 text-lg">
                ...
                <Card key={item.tld} className="hover:border-primary/50 transition-colors">
                  <CardContent className="p-6 text-center">
                    ...
                    <Button variant="destructive" className="w-full" asChild>
                      <a href="https://clients.snwhitehosting.com/cart.php?a=add&domain=transfer">
                        {translateProductText("Transfer", language)}
                      </a>
                    </Button>
                  </CardContent>
                </Card>
