...
export default function DomainsPage() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault()
    if (domain.trim()) {
      window.location.href = `${CLIENT_URL}/cart.php?a=add&domain=register&query=${encodeURIComponent(domain)}`
    }
  }
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">
                {translateProductText("Find Your Perfect Domain", language)}
              </h1>
                ...
                <Card key={item.tld} className="hover:border-primary/50 transition-colors">
                  <CardContent className="p-6 text-center">
                    ...
                    <Button variant="destructive" className="w-full" asChild>
                      <a href={`${CLIENT_URL}/cart.php?a=add&domain=register`}>
