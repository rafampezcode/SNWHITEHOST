          ...
          <div className="lg:col-span-1">
            <div className="prose prose-lg prose-neutral dark:prose-invert max-w-none ">
              ...
              <section className="mb-8">
                <h2>1. Purpose</h2>
                <p>
                  This Service Level Agreement ("SLA") sets forth the availability and quality commitments that SN WHITE HOSTING, a trade name of SN SOLUTIONS LLC ("Provider"), offers to its customers ("Client") for Shared Hosting, WordPress Hosting, VPS, Dedicated Servers, Game Servers, StorageBox, and related services.
                </p>
              </section>
