...
export default function DomainNameTransferAgreementPage() {
  ...
  return <LegalDocumentPage icon={ArrowRightLeft} title={t.legal.domainTransferTitle} subtitle={t.legal.domainTransferSubtitle} currentPath="/domain-name-transfer-agreement" content={localizedContent} />
}
